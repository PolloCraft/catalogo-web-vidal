            ...
            <div className="mb-6">
              ...
              <div className="flex flex-col gap-3">
                ...
                <a
                  ...
                  className={`w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-bold shadow-md transition-all active:scale-[0.98] ${
                    producto.stock === 0
                      ? 'bg-gray-300 text-gray-500 cursor-not-allowed pointer-events-none'
                      : 'bg-[var(--color-whatsapp)] hover:opacity-90 text-white'
                  }`}
                >
                  ...
                  {producto.stock === 0 ? 'Agotado' : 'Cotizar por WhatsApp'}
                </a>
              </div>
            </div>
