...
export default function ProductCard({ product }: Props) {
  ...
  return (
    <Link
      ...
      className="group bg-white rounded-2xl overflow-hidden border border-[var(--color-border)] hover:border-[var(--color-primary)]/40 hover:shadow-lg hover:shadow-[var(--color-primary)]/10 transition-all duration-300 hover:-translate-y-1 flex flex-col shadow-sm"
    >
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <div className="flex items-center justify-between mt-auto">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              href={whatsappCotizarDesdeCard(product.nombre, product.sku)}
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full bg-[var(--color-whatsapp)] hover:opacity-90 text-white flex items-center justify-center shadow-md transition-all active:scale-[0.98]"
